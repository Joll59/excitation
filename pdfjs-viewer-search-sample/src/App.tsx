...
] // This should mock output from Argus. (Verify with actual output from Argus)
function App() {
  const [questionPage, setQuestionPage] = useState(1);
  const [selection, setSelection] = useState(""); // selection from iframe
